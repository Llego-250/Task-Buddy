...
/* Enhanced Edit and Delete Button Styles */
.edit-btn {
  background: linear-gradient(135deg, #3b82f6, #2563eb);
  color: white;
  border: none;
...
.subtask-edit-input, .subtask-hours-input {
  padding: 8px 10px;
  border: 1px solid rgba(255, 255, 255, 0.2);
  border-radius: 6px;
  background: rgba(255, 255, 255, 0.1);
...
.subtask-edit-input::placeholder, .subtask-hours-input::placeholder {

...
export const INITIAL_TASKS = [
  {
    id: 1, columnId: 'todo',
    title: null,
    assignee: { name: 'Darlene Robertson', avatar: 'https://i.pravatar.cc/32?img=1' },
    ...
    members: ['https://i.pravatar.cc/24?img=2','https://i.pravatar.cc/24?img=3'],
  ...
  },
  {
    id: 2, columnId: 'todo',
    title: null,
    assignee: { name: 'Savannah Nguyen', avatar: 'https://i.pravatar.cc/32?img=5' },
    date: '04/24  1:14 PM', dueDate: '',
    description: null,
    channel: { name: 'Gmail', icon: 'gmail' },
    members: ['https://i.pravatar.cc/24?img=6'],
  ...
  },
  {
    ...
    channel: { name: 'Discord', icon: 'discord' },
    members: ['https://i.pravatar.cc/24?img=7','https://i.pravatar.cc/24?img=8'],
  ...
  },
  {
    ...
    title: null,
    assignee: { name: 'Leslie Alexander', avatar: 'https://i.pravatar.cc/32?img=9' },
    date: '02/22  09:33 AM', dueDate: '',
    description: 'Do the best password option when login & send email for doting this...',
    channel: { name: 'Slack', icon: 'slack' },
    members: ['https://i.pravatar.cc/24?img=10'],
    extraMembers: 0, image: null,
    priority: 'High', category: 'Development',
  },
  {
    ...
    date: '02/22  09:33 AM', dueDate: '',
    description: null,
    channel: { name: 'Messenger', icon: 'messenger' },
  ...
  },
  {
    ...
    description: null,
    channel: { name: 'Gmail', icon: 'gmail' },
    members: ['https://i.pravatar.cc/24?img=13'],
    extraMembers: 0, image: null,
  ...
  },
  {
    ...
    description: 'Do the best password option when login & send email for doting this...',
    channel: { name: 'GitHub', icon: 'github' },
    members: ['https://i.pravatar.cc/24?img=14'],
    extraMembers: 0, image: null,
  ...
  },
  {
    ...
    description: null,
    channel: { name: 'Messenger', icon: 'messenger' },
    members: ['https://i.pravatar.cc/24?img=15'],
    extraMembers: 0,
  ...
  },
  {
    ...
    description: null,
    channel: { name: 'Microsoft Team', icon: 'teams' },
    members: ['https://i.pravatar.cc/24?img=16'],
    extraMembers: 0,
  ...
  },
  {
    id: 10, columnId: 'done',
    title: null,
    assignee: { name: 'Brooklyn Simmons', avatar: 'https://i.pravatar.cc/32?img=17' },
    date: '11/23  4:28 PM', dueDate: '',
    description: 'Lorem Ipsum is simply dummy text printing and typesetting industry. Lorem Ipsum has been...',
    channel: { name: 'Slack', icon: 'slack' },
    members: ['https://i.pravatar.cc/24?img=18','https://i.pravatar.cc/24?img=19'],
